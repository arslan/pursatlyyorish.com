    ...
    return (
        <>
            <div className="max-w-7xl mx-auto  py-20 relative">
                <h1 className="sm:text-5xl md:text-6xl lg:text-7xl text-[#fff] text-center font-bold">
                    {t("common.contacts")}
                </h1>
                <div className="px-12">
                    <ContactInfo />
                ...
                <div className={`${styles.contactFormMap} pb-24 px-12 flex`}>
                    <div
                        className={` ${styles.form} lg:w-1/3 flex-grow sm:m-4 md:mr-12`}
                    >
                        <Form />
                    </div>
                    <div
                        className={`${styles.map} md:w-2/3 sm:hidden lg:block`}
                    >
                        <iframe
